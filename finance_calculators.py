...
print("Welcome to your financial calculator. Are you interested in investment or a home loan?")
print("Please enter either 'investment' or 'bond' from the menu above to proceed:")
